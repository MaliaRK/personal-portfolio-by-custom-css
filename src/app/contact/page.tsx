...
const Contact = () => {
  ...
  return (
    <div className='bg-[#1f2937] text-white py-5 mx-1 sm:mx-6 md:mx-[24px]' id='contact'>
        ...
        <div className='md:flex items-center justify-center my-10'>
            ...
            <form className='mx-[20%] md:mx-0'>
                ...
                <p><textarea name='message' rows={5} cols={25} className='pl-1 outline-none rounded-sm bg-transparent border-[1px] border-white' required/></p>
