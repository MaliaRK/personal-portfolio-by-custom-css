...
//   return (
//     <>
//         <div className='grid sm:grid-cols-1 md:grid-cols-[50%_auto] bg-gray-800 text-white mx-2 md:mx-6 py-5 px-16 border-2 border-cyan-500 rounded md:rounded-none' id='home'>
