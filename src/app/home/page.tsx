...
const Home = () => {
    ...
    const downloadCV = () => {
        const fileId = '1yqQSXJkO0SD7zu5rWc-SynWBWzy9jZ-3';
        ...
        <div>
            <div className='home'>
                <div className='homeContent'>
                    ...
                    <button onClick={downloadCV} className='bg-gradient-to-r from-[#06b6d4] to-[#1e7583] text-white rounded py-1 px-4 font-semibold hover:scale-105 duration-150'>
                        Download CV
                    </button>
                </div>
